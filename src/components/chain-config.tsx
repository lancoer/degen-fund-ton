...
const ChainConfig = () => {
  ...
  const [modifiedSlippage, setModifiedSlippage] = useState(slippage.toString());
  ...
  const handleSave = () => {
    ...
    if (
      isNaN(Number(modifiedSlippage)) ||
      Number(modifiedSlippage) < 0 ||
      Number(modifiedSlippage) > 100
    ) {
            ...
            <div className="space-y-4">
              <div>
                ...
                <span className="text-xs text-muted-foreground">
                  Modify the max slippages for your trades. Default: 5%
                </span>
              </div>
              {/* <div>
